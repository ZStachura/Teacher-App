 ...
 * Use the [Fragmet_one_group.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragmet_one_group : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fragmet_one_group, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragmet_one_group.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fragmet_one_group().apply {
